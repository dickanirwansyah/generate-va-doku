...
public class BankMandiriVAService {

    @Value("${doku.client-id}")
    private String dokuClientId;

    @Value("${doku.mandiri.url-generate-va-mandiri}")
    private String dokuMandiriUrlGenerateVa;

    @Value("${doku.mandiri.url-generate-va-sandbox}")
    private String urlSandboxDokuMandiriGenerateVa;
    ...
    public HashMap<String,Object> execute(GenerateVARequest request) throws NoSuchAlgorithmException, InvalidKeyException, JsonProcessingException {
        log.info("execute generate va account bank mandiri..");
        var requestId = UUID.randomUUID().toString();
        String requestTimestamp = GenerateTimestamp.timestampConverter();
        //String jsonBody = "{\"order\":{\"invoice_number\":\"INV-20210124-0003\",\"amount\":150000},\"virtual_account_info\":{\"billing_type\":\"FIX_BILL\",\"expired_time\":60,\"reusable_status\":false,\"info1\":\"Merchant Demo Store\",\"info2\":\"Thank you for shopping\",\"info3\":\"on our store\"},\"customer\":{\"name\":\"Anton Budiman\",\"email\":\"anton@example.com\"}}";
        ...
        ResponseEntity<String> response = restTemplate.exchange(
                urlSandboxDokuMandiriGenerateVa,
                HttpMethod.POST,
                requestEntity,
                String.class);
